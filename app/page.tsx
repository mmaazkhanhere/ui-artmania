...
const Home = (props: Props) => {
  return (
    ...
    <div className='xl:max-w-[1500px] lg:max-w-[1200px] md:max-w-[800px] max-w-[380px] mx-auto md:p-5 lg:p-0'>
      ...
      <section className='flex flex-col items-center justify-center mt-[50px]'>
        <Image src='/assets/header.png' alt='ArtMania Screenshots' width={700} height={700}
          className='md:w-[650px] lg:w-[700px]'
        />
        <p className='font-kanit md:text-[38px] lg:text-[42px] italic text-center mt-[100px]'>
      ...
      <section>
        <h1 className='font-kanit md:text-[46px] lg:text-[52px] underline decoration-accent uppercase tracking-[8px] mt-[100px]'>
          Research
        </h1>
        ...
        <div className='grid grid-cols-2 w-full mt-[50px] gap-8'>
          ...
          <article className='w-full h-[300px] bg-accent text-primary flex items-center justify-center rounded-lg'>
            <p className='md:text-[22px] lg:text-[24px] text-center p-8'>
        ...
        {/*painpoints */}
        <h4 className='uppercase md:text-[22px] lg:text-[24px] font-kanit font-bold tracking-[4px] mt-[100px]'>
      ...
      <section className='flex flex-col items-start justify-center mt-[100px]'>
        <p className='md:text-[20px] lg:text-[22px] font-kanit'>
        ...
        />
        <p className='md:text-[20px] lg:text-[22px] mt-[50px]'>
      ...
      <section className='flex flex-col items-start justify-center'>
        ...
        {/*userflow */}
        <p className='mt-[100px] md:text-[20px] lg:text-[22px]'>
        ...
        {/*paper wireframe */}
        <h4 className='uppercase text-[21px] lg:text-[24px] font-kanit font-bold tracking-[4px] mt-[100px]'>
          Paper Wireframes
        </h4>
        <p className='mt-[50px] md:text-[20px] lg:text-[22px]'>
        ...
        {/*digital wireframe */}
        <h4 className='uppercase md:text-[21px] lg:text-[24px] font-kanit font-bold tracking-[4px] mt-[100px]'>
          Digital Wireframes
        </h4>
        <p className='mt-[50px] md:text-[20px] lg:text-[22px]'>
        ...
        <div className='flex lg:items-center justify-center lg:flex-row flex-col w-full'>
          <p className='mt-[50px] md:text-[20px] lg:text-[22px] lg:w-1/2'>
          ...
          <Image src='/assets/usability.png' alt="Expert page wireframe" width={800} height={800} className='lg:w-1/2 md:mt-[50px] lg:mt-0' />
        </div>
        ...
        <div className='grid grid-cols-2 gap-10 md:mt-[50px] lg:mt-0'>
        ...
        <p className='mt-[50px] md:text-[20px] lg:text-[22px] font-kanit '>
        ...
        {/*Findings */}
        <div className='grid md:grid-cols-2 grid-cols-1 md:gap-5 lg:gap-10 mt-[50px]'>
          {/*1st Grid */}
          <article className='flex items-center justify-center w-full bg-accent/50 list-inside h-[250px] rounded-lg'>
            <ol className=' list-decimal md:text-[20px] lg:text-[22px] md:p-4 lg:p-8 text-primary font-bold text-left'>
              <li className='ml-4'>
        ...
        <p className='mt-[50px] text-[20px] lg:text-[22px] font-kanit '>
        ...
        <p className='mt-[50px] md:text-[20px] lg:text-[22px] font-kanit'>
          ...
          <br />
          <Link href='https://www.figma.com/proto/BEYOcWrj1oMpmxNGPnzsTf/Untitled?page-id=0%3A1&type=design&node-id=1-9&viewport=-698%2C66%2C0.86&scaling=scale-down&starting-point-node-id=1%3A2
'
            className='pt-[20px] text-accent text-[18px] hover:font-bold'
          >
            https://www.figma.com/proto/BEYOcWrj1oMpmxNGPnzsTf/Untitled?page-id=0%3A1&type=design&node-id=1-9&viewport=-698%2C66%2C0.86&scaling=scale-down&starting-point-node-id=1%3A2
          </Link>
        </p>
      ...
      <section>
        ...
        <div className='flex items-center justify-center lg:flex-row flex-col gap-8 w-full'>
          <p className='mt-[50px] md:text-[20px] lg:text-[22px] lg:w-2/5'>
          ...
          <p className='md:mt-[20px] lg:mt-[50px] md:text-[28px] lg:text-[32px] font-kanit text-accent lg:w-3/5 italic'>
        ...
        <div className='grid lg:grid-cols-3 gird-cols-1 md:gap-5 lg:gap-10 mt-[50px]'>
          <div className='w-full bg-accent text-primary h-[250px] text-[22px] flex items-center justify-center p-4 
          ...
          <div className='w-full bg-accent text-primary h-[250px] text-[22px] flex items-center justify-center p-4 rounded-lg 
      ...
      {/*Footer */}
      <footer className='border-t-2 border-accent flex flex-col mt-[100px] items-center justify-center md:text-center'>
        <p className='text-[16px]'>
          If you would like to get in touch, feel free to get in touch. I will be looking forward to work with you
        </p>
        <span className='text-accent md:[25px] lg:mt-[30px]'>
